...
<?php
	...
	$sql = "select * from board_etc order by num desc";
...
<?php
	...
	{
		$new_page = $page-1;
		echo "<li><a href='board_list_etc.php?page=$new_page'>◀ 이전</a> </li>";
	}		
	else 
		echo "<li>&nbsp;</li>";
   	...
   	for ($i=1; $i<=$total_page; $i++)
   	{
		...
		{
			echo "<li><a href='board_list_etc.php?page=$i'> $i </a><li>";
		}
   	}
   	if ($total_page>=2 && $page != $total_page)		
   	{
		$new_page = $page+1;	
		echo "<li> <a href='board_list_etc.php?page=$new_page'>다음 ▶</a> </li>";
	}
	else 
		echo "<li>&nbsp;</li>";
?>
...
<?php 
    if($userid) {            
?>
                    <a href="board_form.php?mode=<?=$mode?>"><button>글쓰기</button></a> <!--mode="etc"-->
<?php
	} else {
?>
